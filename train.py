...
- take profit at +~1.554% long (`take_profit_pct`; shorts use `short_take_profit_pct` ~1.93%)
...
- take profit at -`short_take_profit_pct` (~1.93% on sample data)
...
class StrategyConfig:
    ...
    take_profit_pct: float = 0.015553  # long TP; shorts use short_take_profit_pct when not None
    short_take_profit_pct: Optional[float] = 0.019335
