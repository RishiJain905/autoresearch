...
- take profit at +~1.554% long (`take_profit_pct`; shorts use `short_take_profit_pct` ~1.9%)
...
- take profit at -`short_take_profit_pct` (~1.9% on sample data)
...
class StrategyConfig:
    ...
    short_take_profit_pct: Optional[float] = 0.0190
