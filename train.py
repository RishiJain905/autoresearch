...
- take profit at +~1.55533% long (`take_profit_pct`; shorts use `short_take_profit_pct` ~2.4%)
...
class StrategyConfig:
    ...
    short_take_profit_pct: Optional[float] = 0.025267959825
    ...
    long_trailing_distance_pct: float = (
        0.00379106107734  # trail ~0.379106109% below the highest price seen for longs (tuned)
    )
