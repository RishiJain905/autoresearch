...
- 50% partial exit at full TP (+6.0%), remaining 50% trails with trailing stop
...
- 50% partial exit at full TP (-8.0%), remaining 50% trails with trailing stop
...
class StrategyConfig:
    ...
    take_profit_pct: float = 0.060  # 6.0% for longs
    short_take_profit_pct: Optional[float] = 0.080  # 8.0% for shorts
