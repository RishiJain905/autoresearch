...
- take profit at +~1.555% long (`take_profit_pct`; shorts use `short_take_profit_pct` ~1.934%)
...
- take profit at -`short_take_profit_pct` (~1.934% on sample data)
...
class StrategyConfig:
    ...
    take_profit_pct: float = 0.0155531  # long TP; shorts use short_take_profit_pct when not None
