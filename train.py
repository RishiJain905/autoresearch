...
- take profit at +~2.4% long (`take_profit_pct`; shorts use `short_take_profit_pct` ~3.1%)
...
- take profit at -`short_take_profit_pct` (~3.1% on sample data)
...
class StrategyConfig:
    ...
    short_take_profit_pct: Optional[float] = 0.031
